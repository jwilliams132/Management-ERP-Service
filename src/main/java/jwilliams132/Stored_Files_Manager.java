...
public class Stored_Files_Manager {
	...
	private void loadSampleCustomerData() {
		...
		Customer[] customers = { new Customer("John Doe", "210-687-4325", "jdoe@gmail.com", "111 doe st."),
				new Customer("Jane Smith", "830-465-3218", "jsmith@yahoo.com", "222 smith st."),
				new Customer("Mike Johnson", "512-462-8473", "mjohnson@hotmail.com", "333 johnson st."),
				new Customer("Emily Davis", "210-785-2632", "edavis@gmail.com", "444 davis st."),
				new Customer("Robert Brown", "830-432-7821", "rbrown@gmail.com", "555 brown st."),
				new Customer("Linda White", "210-783-3355", "lwhite@gmail.com", "666 white st.") };
